...
//
//
//    public Location getBestLocation(Map<String, Location> mapOfPotentialLocations){
//        Map<String, Location> initialCheckedMapOfCandidateLocations =
//                getInitialCheckedMapOfCandidateLocations(mapOfPotentialLocations);
...
//    }
//
//    public Map<String, Location> getInitialCheckedMapOfCandidateLocations(Map<String, Location> mapOfPotentialLocation) {
//        return mapOfPotentialLocation.entrySet().stream()
